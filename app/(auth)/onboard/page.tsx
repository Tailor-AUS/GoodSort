...
export default function OnboardPage() {
  ...
  const [lat, setLat] = useState(-27.482);
  const [lng, setLng] = useState(153.021);
      ...
      <div className="h-dvh bg-white flex flex-col items-center justify-center px-6">
        <div className="w-full max-w-sm">
          ...
          <input
            ...
            className="w-full border border-slate-200 rounded-xl px-4 py-3.5 text-base text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500 mb-4"
            autoFocus
          />
        ...
        <div className="space-y-3 mb-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g. 45 Boundary St, South Brisbane"
          ...
          <div>
            ...
            <input
              ...
              placeholder={name ? `${name}'s Place` : "e.g. The Smiths"}
              className="w-full border border-slate-200 rounded-xl px-4 py-3.5 text-base text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500"
            />
          </div>
        </div>
