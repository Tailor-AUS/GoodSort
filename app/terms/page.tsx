    ...
    <div className="min-h-dvh bg-white px-6 py-12 max-w-2xl mx-auto">
      ...
      <div className="prose prose-slate prose-sm">
        ...
        <p className="text-slate-600 text-sm mb-4">
          ...
          operates a scan-first container sorting and kerbside collection service in Queensland.
          You scan eligible cans and bottles for a 5¢ sorting credit, sort into four streams at home,
          and invite neighbours to scan. When your suburb reaches enough scanned container volume for
          one driver trip (about 1,000 containers), we unlock a volume run. We contact you when to
          bag out sorted containers on the kerb. You authorise The Good Sort and its appointed runners
          (&quot;Runners&quot;) to collect those bagged containers and return eligible items to approved
          recycling depots or refund points. The Good Sort is the entity that returns containers to
          Container Refund Points under the Queensland Container Refund Scheme (Containers for Change).
        </p>
        ...
        <p className="text-slate-600 text-sm mb-4">
          ...
          reward paid by The Good Sort for scanning, sorting, and authorising collection of eligible
          containers. Sorting Credits are <strong>not</strong> the 10-cent container refund under the Queensland
        ...
        <p className="text-slate-600 text-sm mb-4">
          ...
          container scanned and later collected and verified). Scanning records a pending credit; it does not
          itself create a scheme refund. Runner Credits are earned at rates displayed in the Runner app.
        ...
        <p className="text-slate-600 text-sm mb-4">
          ...
          you set aside for collection that are not collected and verified will not earn credits and may result in account review.
        </p>
        ...
        <p className="text-slate-600 text-sm mb-4">
          ...
          not in your sorted bags; submitting false pickup or delivery confirmations; manipulating
        ...
        <h2 className="text-lg font-display font-bold text-slate-900 mt-8 mb-3">9. Bags, Bins and Property</h2>
        <p className="text-slate-600 text-sm mb-4">
          You sort into your own bags (or a bin we may supply later). Eligible containers become the
          property of The Good Sort when a runner collects them from the kerb under your consent.
          Tampering with a runner&apos;s collection or removing containers after they have been set
          aside for us may constitute theft. Any sorting equipment we supply remains
          our property unless we say otherwise.
        </p>
